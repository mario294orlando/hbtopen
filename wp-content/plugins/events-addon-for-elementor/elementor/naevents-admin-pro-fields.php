...
// Eventbrite Event (Pro) - Checkbox
if ( ! function_exists( 'naeafe_pro_eventbrite_event_render' ) ) {
  function naeafe_pro_eventbrite_event_render() {
    $options = get_option( 'eafe_prow_settings' );
    ?>
    <label class="switch">
      <input type='checkbox' name='eafe_prow_settings[naeafe_pro_eventbrite_event]' id='naeafe_pro_eventbrite_event-id' <?php checked( isset($options['naeafe_pro_eventbrite_event']), 1 ); ?> value='1' />
      <span class="slider round"></span>
    </label>
    <?php
  }
...
// Eventbrite Events (Pro) - Checkbox
if ( ! function_exists( 'naeafe_pro_eventbrite_events_render' ) ) {
  function naeafe_pro_eventbrite_events_render() {
    $options = get_option( 'eafe_prow_settings' );
    ?>
    <label class="switch">
      <input type='checkbox' name='eafe_prow_settings[naeafe_pro_eventbrite_events]' id='naeafe_pro_eventbrite_events-id' <?php checked( isset($options['naeafe_pro_eventbrite_events']), 1 ); ?> value='1' />
      <span class="slider round"></span>
    </label>
    <?php
  }
