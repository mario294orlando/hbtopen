...
if ( !function_exists( 'eafe_prow_settings_init' ) ) {
    function eafe_prow_settings_init()
    {
        ...
        $naevents_pro_widgets['pro_eventbrite_event'] = __( 'Eventbrite Event (Pro)', 'events-addon-for-elementor' );
        $naevents_pro_widgets['pro_eventbrite_events'] = __( 'Eventbrite Events (Pro)', 'events-addon-for-elementor' );
